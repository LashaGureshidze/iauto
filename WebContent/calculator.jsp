		...
		<td align=center width=100%><br /> <br />
			<table width="80%" border="0">
				<tr>
					...
					<td align="left" width="25%"><label id="lab_excise"> 0</label>
						ლარი</td>
				</tr>
				<tr>
...
<table width=80% border="0">
	<tr>
		<td>
			<center>შიდა ტრანზიტის ღირებულება 1 დღე - 1 ლარი.</center> <br />
			მოტოციკლების და სპეცტექნიკის განბაჟების დროს განბაჟების ღირებულება
			შეადგენს სატრანსპორტო საშუალების ღირებულების 18% -ს + საბაჟო
			მომსახურების გადასახადი 300 ლარი <br /> მოტოციკლის ტექნიკუტი
			დათვალიერების და ტექნიკური პასპორტის აღების საფასური შეადგენს 62 ლარს
			<br />
			<p>საქართველოს საგადასახადო კოდექსის 188 მუხლის მიხედვით მსუბუქი
				ავტომობილის განბაჟების ტარიფის სააქციზო განაკვეთი დამოკიდებულია
				ავტომობილის ასაკზე(დასაბეგრი ოპერაციის განხორციელების წელსა და
				მსუბუქი ავტომობილის გამოშვების წელს შორის სხვაობა). აქციზის
				გადასახადს ვიღებთ სააქციზო განაკვეთის გამრავლებით მისი ძრავის
				მოცულობაზე.</p> <br> 1 წლამდე 1.5  <br>1 წლის 1.5 <br> 2 წლის 1.4<br> 3
			წლის 1.3<br> 4 წლის 1.2<br> 5 წლის 1.0<br> 6 წლის 0.7<br> 7 წლის 0.5<br> 8 წლის 0.5<br> 9
			წლის 0.5<br> 10 წლის 0.5<br> 11 წლის 0.5<br> 12 წლის 0.5<br> 13 წლის 0.6<br> 14 წლის 0.7<br>
			14 წელზე მეტის 0.8 <br>
			<p>მიღებულ თანხას ემატება საბაჟო მომსახურებისგადასახადი რომელიც
				შეადგენს ფიქსირებულად 150 ლარს და იმპორტის გადასახადი(მომსახურების
				გადსახადში შედის ასევე დეკლარაციის შევსება, ამ მომსახურებაში
				დამატებით გადასახადს არ იხდით). იმპორტის გადასახადის გამოსათვლელად
				ავტომობილის ძრავის კუბატურას ვამრავლებთ 0.05-ზე და მიღებულ რიცხვს
				ვუმატებთ ავტომობილის ასაკის, ძრავის კუბატურის და 0.0025-ის ნამრავლს.
				ანუ იმპორტის გადასახადი=(კუბატურა*0.05)+(კუბატურა*ასაკი*0.0025).</p>

			<p>ამ თანხას ემატება ავტომობილის ტექნიკური პასპორტის, ტექნიკური
				დათვალიერების და ნომრის აღების საფასური, რომელიც ფიქსირებულად
				შეადგენს 72 ლარს.</p>
		</td>
	</tr>
</table>
